...
var makeItActiveUtil = function ($, eatingName) {
    $(".addible").each(function () {
        $(this).removeClass("active");
        $(this).parent().find(".clearEating").remove();
        $(this).parent().find(".delEating").remove();
...
var addFoodsByRequestUtil = function ($, choosenFood) {      // choosenFood - is a string like "name Of Food 1, name Of Food 2, name Of Food 3, ...."
