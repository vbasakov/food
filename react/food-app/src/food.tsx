                ...
                <div id="content" className="site-content" style="height: auto !important;">
                    <div id="primary" className="content-area" style="height: auto !important;">
                        <main id="main" className="site-main" role="main" style="height: auto !important;">
                            ...
                            // <!--	<h1 class="entry-title">1. План питания</h1> -->
                            ...
                            <div className="entry-content" style="height: auto !important;">
                                <div className="mainContainer">
                                    <div className="calcCont row">
                                        <div className="tableFAQ stepDiv">
                                            ...
                                            <div>
                                                <p>Для кого-то это будет открытием, но вы можете
                                                    ...
                                                    никаких уловок, чудо-средств или магии, только суровые законы природы.
                                                    ...
                                                    собственный план питания, идеально подходящий именно ему. На самом деле,
                                                    это вовсе не так долго и сложно, как может показаться сначала. Просто
                                                    следуйте инструкциям на этой странице – и у вас все получится!</p>
                                                <p>Что нужно делать:</p>
                                                <ul>
                                                    <li>определите потребности своего организма в калориях и нутриентах;</li>
                                                ...
                                                <div className="articlesHolder">
                                                    <fieldset>
                                                        <legend>Подробный обзор литературы о том, стоит ли считать калории:
                                                        </legend>
                                                        <div className="article">
                                                            <div className="box artcal4">
                                                                <div className="cover top">
                                                                    <h2 className="arttitle">Имеет ли смысл считать калории?</h2>
                                                                    <a className="readmoar"
                                                                       href="http://3-x-15.ru/2017/06/21/calories_counting/">Критически
                                                                        и беспристрастно отвечаем на вопрос: имеет ли смысл
                                                                        ориентироваться на
                                                                        подсчет калорий, и насколько этот метод может быть
                                                                        эффективен.</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        // <!-- calcFAQ start -->
                                        <div className="tableFAQ stepDiv">
                                            <h2 className="h2 mainFAQ">Пространные разглагольствования о том, зачем все это нужно и
                                                почему вы никогда подобного не видели (читать необязательно).</h2>
                                            <div>
                                                <p>Если вы уделите время этой странице,
                                                    внимательно ознакомитесь с ее содержимым и проявите некоторое терпение, в
                                                    конечном итоге в ваших руках окажется уникальный план питания,
                                                    созданный вами и для вас. Он гарантированно будет удовлетворять именно
                                                ...
                                                <p>Это индивидуально, 100% эффективно и не будет стоить вам ни копейки. Я
                                                    серьезно. Похудеть бесплатно, без смс и регистрации, да.</p>
                                                <p>Самым главным, самым важным и самым первым
                                                    шагом на пути к пресловутому телу своей мечты является понимание одной
                                                    простой вещи. Вам необходимо понять и принять элементарный, но очень
                                                    важный принцип. Если вы еще не слышали – слушайте, сейчас он прозвучит:
                                                    единственный способ увеличить или уменьшить массу тела – изменить
                                                    количество энергии (калорий), которую вы получаете с пищей. Всё. Других
                                                    способов нет и никогда не было. Так устроен мир и это один из законов,
                                                ...
                                                <p>Итак, мы, скрепя сердце, признаём могущество
                                                    и абсолютную власть законов Природы над нами и понимаем: чтобы похудеть
                                                    – надо употреблять калорий меньше, чем мы тратим. Чтобы набрать вес –
                                                    наоборот. Если вы будете придерживаться этого принципа – вы обречены на
                                                    успех.</p>
                                                <p>Множество сайтов сегодня предлагают готовые
                                                    рационы для снижения/увеличения массы тела, но на большинстве
                                                    пользователей это работать не будет. Главным образом, по двум причинам:</p>
                                                <ul className="FAQul">
                                                    <li>создатели этих сайтов не знают, сколько калорий в день нужно потреблять
                                                        именно вам для достижения ваших целей;
                                                    </li>
                                                    <li>вы не знаете, сколько калорий в день нужно потреблять именно вам для
                                                        достижения ваших целей.
                                                    </li>
                                                </ul>
                                                <p>Обычно это происходит так. Вы заходите на
                                                    очередной фитнес-портал и сохраняете оттуда очередной план питания на,
                                                    допустим, 1800 ккал, который, якобы, поможет вам похудеть. К сожалению,
                                                    вероятность этого крайне мала.</p>
                                                <p>Как вы считаете, сколько калорий вам нужно
                                                    потреблять в сутки для достижения цели? Подумайте минуту, не торопитесь,
                                                ...
                                                <p>Так вот, это неправильная цифра. Вообще. Даже
                                                    ...
                                                    калорий в день. Между тем, эта цифра для вас критически важна. Именно
                                                    отталкиваясь от нее можно реально влиять на вес. Хорошая новость состоит
                                                ...
                                                <p>Далее. Вы воспользовались калькулятором
                                                    ...
                                                    Именно столько вам нужно, чтобы, допустим, похудеть. Но что это за 2000
                                                    ккал/сут? В чем они выражаются в реальной жизни? Сколько и чего можно
                                                ...
                                                <p>Для ответа на эти вопросы я сделал таблицу.
                                                    Она разбита на приемы пищи, в которые можно добавлять продукты. Таблица
                                                    будет считать суммарное количество нутриентов и калорий и сравнивать с
                                                    вашими целевыми цифрами. Вы также можете воспользоваться готовыми
                                                    рационами с калоражем, приближенным к вашей целевой цифре и поиграть с
                                                ...
                                                <ul className="FAQul">
                                                    <li>донести до пользователя идею, что
                                                        похудеть или набрать массу гарантированно может каждый, своими силами,
                                                        независимо от возраста, пола, вида деятельности или “уровня
                                                        метаболизма”;
                                                    </li>
                                                    <li>дать пользователю представление о его реальной ежедневной потребности в
                                                        энергии;
                                                    </li>
                                                    <li>продемонстрировать «на пальцах», что
                                                        рацион для похудения на 1200 ккал может состоять не только из брокколи и
                                                        огурцов, а для набора массы на 3500 ккал – из сала в шоколаде;
                                                    </li>
                                                    <li>показать, что любые цели в питании достижимы без применения БАДов,
                                                        других добавок и спортивного питания;
                                                    </li>
                                                    <li>быстро набросать план питания или прикинуть калорийность приема пищи без
                                                        всяких регистраций, не отходя от кассы.
                                                    </li>
                                                </ul>
                                                <p>Для чего эта страница НЕ создана и что она НЕ может:</p>
                                                <ul className="FAQul">
                                                    <li>она не является ежедневным счетчиком калорий, для этого есть отличные
                                                        приложения типа <a href="https://www.myfitnesspal.com/ru"
                                                                           target="_blank">myfitnesspal</a>, <a
                                                            href="http://www.fatsecret.ru/" target="_blank">fatsecret</a> и
                                                        десяток других подобных;
                                                    </li>
                                                    <li>она намеренно не содержит готовых блюд,
                                                        потому что одну и ту же киевскую котлету можно пожарить так, что разброс
                                                        в калориях на порцию будет исчисляться сотнями.
                                                    </li>
                                                </ul>
                                                <p>Теперь вы знаете достаточно для того, чтобы добиться своей цели. Вперед!</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="formCont stepDiv"><!-- 1 step start -->
                                            ...
                                            <form className="formMainCalc">
                                                <div className="genderDiv row">
                                                    <div className="col-sm-12 col-md-6">
                                                        ...
                                                        <label className="genderLabel" htmlFor="male">
                                                            <input type="radio" className="gender" value="male" name="sex" id="male"
                                                                   checked="checked"> <span className="frame"
                                                                                            id="maleS">Мужчина</span>
                                                        </label>

                                                        <label className="genderLabel" htmlFor="female">
                                                            <input type="radio" className="gender" value="female" name="sex"
                                                                   id="female"> <span className="frame" id="femaleS">Женщина</span>
                                                        </label>
                                                    ...
                                                    <div className="col-sm-12 col-md-6">
                                                        <div className="paramDivs">
                                                            <span className="divTitle ageT">Возраст</span><br><input id="age"
                                                                                                                 type="text"
                                                                                                                 className="age frame"
                                                                                                                 name="age"
                                                                                                                 value="36"><br>
                                                        ...
                                                        <div className="paramDivs">
                                                            <span className="divTitle heightT">Рост</span><br><input id="height"
                                                                                                                 type="text"
                                                        ...
                                                        <div className="paramDivs">
                                                            <span className="divTitle weightT">Вес</span><br><input id="weight"
                                                                                                                type="text"
                                                ...
                                                <div className="row">
                                                    <div className="activityDiv col-xs-12 col-md-offset-1 col-md-10">
                                                        ...
                                                        <label className="inputLable" htmlFor="Sedentary">
                                                            <input id="Sedentary" className="activity" type="radio" name="activity"
                                                                   value="1.2"><span>Веду сидячий образ жизни</span>
                                                        </label>

                                                        <label className="inputLable" htmlFor="v3">
                                                            <input id="v3" className="activity" type="radio" name="activity"
                                                                   value="1.375" checked="checked"><span>Занимаюсь активными видами спорта не менее 30 мин 3 раза в неделю</span><br>
                                                        </label>

                                                        <label className="inputLable" htmlFor="v4">
                                                            <input id="v4" className="activity" type="radio" name="activity"
                                                                   value="1.418"><span>4 раза в неделю</span><br>
                                                        </label>

                                                        <label className="inputLable" htmlFor="v5">
                                                            <input id="v5" className="activity" type="radio" name="activity"
                                                                   value="1.462"><span>5 раз в неделю</span><br>
                                                        </label>

                                                        <label className="inputLable" htmlFor="v6">
                                                            <input id="v6" className="activity" type="radio" name="activity"
                                                                   value="1.506"><span>6 раз в неделю</span><br>
                                                        </label>

                                                        <label className="inputLable" htmlFor="v7">
                                                            <input id="v7" className="activity" type="radio" name="activity"
                                                        ...
                                                        <input type="button" className="calc btn" value="Посчитать!"><span
                                                ...
                                                <div className="calcResultsDiv">
                                                    <p className="results">Супер! Теперь мы знаем вашу потребность в энергии: это
                                                        <span className="tdee_ex_int"></span>
                                                        ккал. Если каждый день вы будете употреблять ровно столько калорий, вы
                                                        не будете ни набирать, ни терять вес, ведь вся потребленная вами
                                                        энергия будет расходоваться. Самое сложное (и важное) уже позади, едем
                                                        дальше.</p>
                                                </div>
                                        ...
                                        <div className="purposeChooserCont stepDiv">
                                            ...
                                            <p>Следующий шаг: нам нужно определиться, чего мы хотим?
                                                ...
                                                будем манипулировать с той <span className="blue">синей</span> цифрой, что
                                            ...
                                            <label className="inputLable" htmlFor="speed1"><input className="activity" type="radio"
                                                                                          name="speed" id="speed1"
                                                                                          value="maintain"><span>Поддерживать вес</span></label><br>
                                            <label className="inputLable" htmlFor="speed2"><input className="activity" type="radio"
                                                                                          name="speed" id="speed2" value="lose"><span>Терять вес</span></label>
                                            <div className="wrapper"><span className="title">Насколько быстро?</span>
                                                <ul className="howFastul">
                                                    <li className="howFastli" data-value="0.85">медленно, но верно (-15%)</li>
                                                    <li className="howFastli" data-value="0.8">в темпе вальса (-20%)</li>
                                                    <li className="howFastli" data-value="0.75">стремительно и безрассудно (-25%)
                                                    </li>
                                                </ul>
                                            </div>
                                            <br>
                                                <label className="inputLable forspeed3" htmlFor="speed3"><input className="activity"
                                                ...
                                                <div className="wrapper"><span className="title">Насколько быстро?</span>
                                                    ...
                                                    <ul className="howFastul">
                                                        <li className="howFastli" data-value="1.15">медленно, но верно (+15%)</li>
                                                        <li className="howFastli" data-value="1.2">в темпе вальса (+20%)</li>
                                                        <li className="howFastli" data-value="1.25">стремительно и безрассудно (+25%)
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="promptForSpeed">Выберите скорость, с которой вы хотите терять или
                                                    набирать вес.
                                                </div>
                                                <p>Для достижения поставленной цели вам необходимо потреблять <span
                                                    className="purposeGoal"></span> калорий в день.<br>Обратите внимание, что синяя
                                        ...
                                        <div className="nutrientsAmountCont stepDiv">
                                            ...
                                            <div>
                                                ...
                                                <select className="frame" id="proteinSelect">
                                                    <option selected="selected" value="1.75">1.75</option>
                                                    <option value="2">2</option>
                                                    <option value="2.2">2.2</option>
                                                </select> гр. на килограмм массы тела – это <span className="protPerDay"></span> гр.
                                                в день, или <span className="kkalsFromProtein">0</span> ккал из вашего дневного
                                                калоража.<br><br>
                                                ...
                                                </select> гр. на килограмм массы тела – это <span className="fatPerDay"></span> гр.
                                                в день, или <span className="kkalsFromFat">0</span> ккал из вашего дневного
                                                калоража.<br><br>
                                                <span className="nutrient">Углеводы </span> расчитываются исходя из оставшихся
                                        ...
                                        <h2 className="heading">Ваш идеальный рацион (план питания) должен содержать:</h2>
                                        ...
                                        <div className="tableFAQ stepDiv">
                                            ...
                                            <div>
                                                <p>С помощью представленной ниже таблицы вы можете
                                                    ...
                                                    подсказывать, если что-либо нужно добавить или убрать из рациона.</p>
                                                ...
                                                <p>Один из них будет подходить вам по калориям оптимально –
                                                    он зеленого цвета, самый крупный, в рамке посередине. Остальные четыре
                                                    выступают в роли набросков, неких шаблонов, которые дают представление о
                                                    ...
                                                    использоваться вами в качестве основных после небольшой коррекции. </p>
                                                <p>Внимание!!!</p>
                                                <p>Мною собрано 100 рационов от 1000 до 6000 ккал/сутки с
                                                    шагом в 50 ккал каждый (1000, 1050, 1100 … 5900, 5950, 6000), таким
                                                    образом покрыт весь разумный диапазон суточного калоража, который будет
                                                    удовлетворять большинству пользователей. Но! Обратите внимание:
                                                    учитывается только калораж.</p>
                                                <p>Рационы, заложенные в программу, не могут удовлетворять всем потребностям
                                                    всех пользователей по определению. </p>
                                                <p>Например. Маше 16 лет, ее рост 168 см, она весит 85 кг, 3 раза в неделю ходит
                                                    в спортзал и хочет похудеть.</p>
                                                <p>Ивану – 30 лет, его рост 168 см, он весит 50 кг, не занимается никакими
                                                    видами спорта и хочет набрать массу. </p>
                                                <p>Им обоим калькулятор выдаст одно и тоже число – 1939 ккал
                                                    в сутки. Именно столько нужно потреблять Марии в день, чтобы похудеть, а
                                                    Ивану – чтобы набрать массу. В этом нет ничего удивительного: ведь люди
                                                    разные и цели у них разные, и одно и тоже число калорий одного будет
                                                    держать в дефиците, а другого – в избытке энергии. Одно и то же число
                                                    ...
                                                    распределяться по-разному. Маше нужно будет потреблять около 140 г белка
                                                ...
                                                <p>Поэтому, нажимая на кнопку рекомендованного вам рациона,
                                                    ...
                                                    абстрактные 2000 ккал, составленное неизвестно кем, непонятно для кого. </p>
                                            </div>
                                        </div>
                                        <!-- tFAQ end -->
                                    </div><!-- calc end -->
                                        ...
                                        <div className="tablesContainer col-xs-12 col-md-7 col-lg-6">
                                            <p className="stepChanger"><b>Шаг +/- грамм продуктов:</b>
                                                <label className="stepChangerLabel" htmlFor="step50">
                                                    <input type="radio" name="stepRange" checked="checked" value="50"
                                                           id="step50">
                                            ...
                                            <ul id="sortable" className="ui-sortable">
                                                <li className="ui-sortable-handle">
                                                    <table className="table addible active" id="breakfast">
                                                        ...
                                                        <tr>
                                                            <th className="name"><input className="eating" type="text" value="Завтрак">
                                                            </th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                ...
                                                <li className="ui-sortable-handle">
                                                    <table className="table addible" id="frstMid">
                                                        <thead>
                                                        <tr>
                                                            <th className="name"><input className="eating" type="text" value="Перекуc">
                                                            </th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                ...
                                                <li className="ui-sortable-handle">
                                                    <table className="table addible" id="lunch">
                                                        <thead>
                                                        <tr>
                                                            <th className="name"><input className="eating" type="text" value="Обед">
                                                            </th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                ...
                                                <li className="ui-sortable-handle">
                                                    <table className="table addible" id="supper">
                                                        <thead>
                                                        <tr>
                                                            <th className="name"><input className="eating" type="text" value="Ужин">
                                                            </th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                                            <th className="col"></th>
                                            ...
                                            <table className="final">
                                                ...
                                                <tr>
                                                    <td className="name total">
                                                        ...
                                                        <span className="addingPrompt">добавить прием пищи в таблицу</span></td>
                                                ...
                                                <tr>
                                                    <td className="name goalTotal total">Ваш идеальный рацион должен содержать:</td>
                                            ...
                                            <!-- <div class="addNewTable btn">+</div> <span>добавить прием пищи в таблицу</span> -->

                                            <!-- <div class="conclPrompt">Если вы воспользуетесь калькулятором и определите свои потребности в нутриентах и калориях, кнопки с дурацкими смайликами будут подсказывать вам, сколько грамм нутриента нужно добавить или убрать, а также подсвечивать продукты, с наибольшим содержанием этого нутриента.</div> -->

                                            <div className="printButton btn" onClick="javascript:window.print()">Распечатать
                                                таблицу
                                            </div>
                                            <div className="clearButton btn">Очистить таблицу</div>
                                            <div className="areYouSure">Вы уверены?<br> <span className="yes">Да</span><span className="no">Нет</span>
                                            </div>
                                            <!--             <a class="saveSet btn">Cохранить</a> -->
                                        </div>
                                        <div className="buttonsContainer col-xs-12 col-md-5 col-lg-6">
                                            <fieldset>
                                                <legend>5 готовых рационов – с учетом вашего калоража</legend>
                                                <div className="promptToCalc">Чтобы получить готовые рационы, сначала посчитайте
                                                    нужное вам количество калорий
                                                </div>
                                                <div className="setHolder">
                                                    <div>
                                                        <button className="inactivePreSet" id="set1"><span></span><br>ккал</button>
                                                    </div>
                                                    <div>
                                                        <button className="inactivePreSet" id="set2"><span></span><br>ккал</button>
                                                    </div>
                                                    <div>
                                                        <button className="inactivePreSet" id="set3"><span></span><br>ккал</button>
                                                    </div>
                                                    <div>
                                                        <button className="inactivePreSet" id="set4"><span></span><br>ккал</button>
                                                    </div>
                                                    <div>
                                                        <button className="inactivePreSet" id="set5"><span></span><br>ккал</button>
                                                    </div>
                                                </div>
                                            ...
                                            <fieldset className="regularButtonsCont">
                                                ...
                                                <div className="plate">
                                                    <div className="groopOfProducts foodPanel">
                                                        <span className="proteinSource carboSource kkalSource">Крупы</span>
                                                        <div>
                                                            <button className="carboSource">Белый рис</button>
                                                            <button className="proteinSource carboSource">Булгур</button>
                                                            <button className="carboSource">Бурый рис</button>
                                                            <button className="proteinSource">Горох сушеный</button>
                                                            <button className="proteinSource carboSource kkalSource">Гречка</button>
                                                            <button className="proteinSource carboSource">Дикий рис(цицания)
                                                            </button>
                                                            <button className="proteinSource carboSource kkalSource">Киноа</button>
                                                            ...
                                                            <button className="proteinSource carboSource">Овсянка</button>
                                                            ...
                                                            <button data-info="  1 порция - 30 г хлопьев и 125 мл обезжиренного молока">
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button data-info="  1/8 лепешки - примерно - 30 г">Лаваш</button>
                                                            <button data-info="  1 пачка в мягкой упаковке - 60 г">Лапша
                                                                Роллтон
                                                            </button>
                                                            <button data-info="  Вид изделий не имеет принципиального значения">
                                                            ...
                                                            <button data-info="  1 кусок - 25 г">Хлеб Бородинский</button>
                                                            <button data-info="  1 кусок - 25 г">Хлеб ржаной</button>
                                                            <button data-info="  1 кусок - 25 г">Хлеб тостовый</button>
                                                            <button data-info="  1 хлебец весит примерно 3 г">Хлебцы</button>
                                                        </div>
                                                    </div>
                                                    <div className="groopOfProducts foodPanel">
                                                        <span className="proteinSource fatSource">Рыба</span>
                                                        <div>
                                                            <button data-info="  ГОСТ 16978-99" className="proteinSource">Бычки в
                                                                томатном соусе
                                                            </button>
                                                            ...
                                                            <button className="proteinSource fatSource">Нототения</button>
                                                            ...
                                                            <button className="proteinSource fatSource">Скумбрия</button>
                                                            <button className="proteinSource">Сом</button>
                                                            <button className="proteinSource fatSource">Ставрида</button>
                                                            ...
                                                            <button data-info="  ГОСТ 280-85" className="proteinSource">Шпроты-1
                                                            </button>
                                                            <button data-info="  ГОСТ 280-2009" className="proteinSource">Шпроты-2
                                                            </button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button data-info="  2 ч.л. какао(14г) + 200 мл молока 1,5%. Состав указан на 100 мл готового напитка">
                                                                Какао Nesquik
                                                            </button>
                                                            <button>Квас</button>
                                                            ...
                                                            <button>Fanta</button>
                                                            <button data-info="  состав указан для вкусов: лимон; зелёный чай">
                                                                Lipton Ice Tea л/зч
                                                            </button>
                                                            <button data-info="  состав указан для вкусов: малина; персик; лайм и мята">
                                                ...
                                                <div className="plate">
                                                    <div className="groopOfProducts foodPanel">
                                                        <span className="proteinSource carboSource fatSource">Овощи</span>
                                                        <div>
                                                            <button>Баклажан</button>
                                                            <button>Брокколи</button>
                                                            <button data-info="  1 шт. - 19 г">Брюссельская капуста</button>
                                                            <button>Горошек зеленый</button>
                                                            <button>Кабачок</button>
                                                            <button>Капуста белокочанная</button>
                                                            <button>Капуста цветная</button>
                                                            <button className="carboSource" data-info="  1 клубень - 150 г">
                                                                Картофель
                                                            </button>
                                                            ...
                                                            <button className="proteinSource carboSource fatSource">Соя</button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        <!-- always put spaces in the begining of data- -->
                                                        <span className="carboSource fatSource">Фрукты и ягоды</span>
                                                        <div>
                                                            <button className="carboSource" data-info="  30 г">Абрикос</button>
                                                            <button className="fatSource" data-info="  1 шт. - 150 г">Авокадо
                                                            </button>
                                                            <button className="carboSource">Ананас</button>
                                                            <button data-info="  150 г">Апельсин</button>
                                                            <button>Арбуз</button>
                                                            <button className="carboSource" data-info="  1 шт. без кожуры - 100 г">
                                                                Банан
                                                            </button>
                                                            <button className="carboSource">Виноград</button>
                                                            <button>Вишня</button>
                                                            <button className="carboSource" data-info="  125 г">Гранат</button>
                                                            <button data-info="  130 г">Грейпфрут</button>
                                                            <button className="carboSource" data-info="  130 г">Груша</button>
                                                            <button>Дыня</button>
                                                            ...
                                                            <button data-info="  1 шт. без кожуры - 100 г">Мандарин</button>
                                                            <button className="carboSource" data-info="  150 г">Персик</button>
                                                            ...
                                                            <button className="carboSource" data-info="  Сорт golden delicious">
                                                                Яблоко зеленое
                                                            </button>
                                                            <button className="carboSource" data-info="  Сорт red delicious">Яблоко
                                                                красное
                                                            </button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        <span className="carboSource proteinSource">Орехи, сухофрукты</span>
                                                        <div>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна столовая ложка - примерно 10 г">Арахис
                                                            </button>
                                                            <button data-info="  Один орех(две половинки) - примерно 6 г">
                                                                Грецкий орех
                                                            </button>
                                                            <button className="carboSource"
                                                                    data-info="  Одна чайная ложка - примерно 7 г">Изюм
                                                            </button>
                                                            <button className="carboSource" data-info="  Одна штука - примерно 9 г">
                                                                Инжир сушеный
                                                            </button>
                                                            <button data-info="  Столовая ложка очищенных ядер - 10 г">Кедровые
                                                                орехи
                                                            </button>
                                                            <button data-info="  Один орешек - примерно 1,5 г">Кешью</button>
                                                            <button className="carboSource"
                                                                    data-info="  Одна штука - примерно 12 г">Курага
                                                            </button>
                                                            <button data-info="  Один орешек - примерно 1,2 г">Миндаль</button>
                                                            <button data-info="  Половина граненого стакана - примерно 40 г">
                                                            ...
                                                            <button data-info="  Одна порция - 10 шт - примерно 6 г">Фисташки
                                                            </button>
                                                            <button data-info="  Один орех - примерно 1,5 г">Фундук</button>
                                                            <button className="carboSource"
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button className="proteinSource fatSource">Моцарелла</button>
                                                            <button className="proteinSource fatSource">Пармезан</button>
                                                            ...
                                                            <button className="fatSource" data-info="  Одна столовая ложка - 25 г">
                                                                Сметана 10%
                                                            </button>
                                                            <button className="fatSource" data-info="  Одна столовая ложка - 25 г">
                                                                Сметана 15%
                                                            ...
                                                            <button className="proteinSource fatSource">Сулугуни</button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            <button className="carboSource" data-info="  Чайная ложка — 15 г">
                                                            ...
                                                            <button className="carboSource" data-info="  Чайная ложка — 10 г">Мёд
                                                            </button>
                                                            ...
                                                            <button className="carboSource" data-info="  Чайная ложка — 7 г">Сахар
                                                            </button>
                                                            <button className="carboSource" data-info="  ГОСТ Р 53436-2009">
                                                                Сгущенка
                                                            </button>
                                                            <button>Шоколад белый</button>
                                                            <button className="fatSource carboSource">Шоколад горький</button>
                                                            <button>Шоколад молочный</button>
                                                            <button data-info="  Классический батончик — 50 г">Mars</button>
                                                            <button data-info="  Один батончик - 23.5 г">Nestle Fitness с
                                                                клубникой
                                                            </button>
                                                            <button data-info="  Один батончик  -23.5 г">Nestle Fitness с
                                                                шоколадом
                                                            </button>
                                                            <button data-info="  Один батончик - 23.5 г">Nestle Fitness со
                                                                злаками
                                                            </button>
                                                            <button data-info="  Столовая ложка — 15 г">Nutella</button>
                                                            <button data-info="  Классический батончик — 48.4 г">Picnic</button>
                                                            <button data-info="  Классический батончик — 52.7 г">Snickers
                                                            </button>
                                                ...
                                                <div className="plate">
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button data-info="  В столовой ложке — 30 г">Паштет из гусиной
                                                                печени Hame
                                                            </button>
                                                            <button className="proteinSource">Печень говяжья</button>
                                                            <button className="proteinSource" data-info="  нежирное мясо">Свиная
                                                                вырезка
                                                            </button>
                                                            <button className="fatSource" data-info="  жирное мясо">Свиная
                                                                грудинка
                                                            </button>
                                                            <button className="proteinSource">Свиная печень</button>
                                                            <button className="proteinSource">Телятина отварная</button>
                                                            <button className="fatSource" data-info="  ГОСТ 32125-2013">Тушенка
                                                            </button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            <button className="proteinSource fatSource"
                                                                    data-info="  Первая категория — 60 г">Яйцо куриное 1с
                                                            </button>
                                                            <button className="proteinSource fatSource"
                                                                    data-info="  Вторая категория — 50 г">Яйцо куриное 2с
                                                            </button>
                                                            <button className="proteinSource fatSource"
                                                                    data-info="  Высшая категория — 70 г">Яйцо куриное вс
                                                            </button>
                                                            <button className="proteinSource fatSource"
                                                            ...
                                                            <button className="proteinSource fatSource" data-info="  150 г">Яйцо
                                                                гусиное
                                                            </button>
                                                    ...
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            <button className="fatSource" data-info="  Столовая ложка — 17 г">Жир
                                                                рыбий
                                                            </button>
                                                            <button className="fatSource" data-info="  Столовая ложка — 13,6 г">
                                                                Льняное масло
                                                            </button>
                                                            <button data-info="  Столовая ложка — 25 г">Майонез Провансаль
                                                            </button>
                                                            <button>Маргарин</button>
                                                            <button data-info="  Столовая ложка — 17 г">Масло сливочное 72,5%
                                                            </button>
                                                            <button data-info="  Столовая ложка — 17 г">Масло сливочное 82%
                                                            </button>
                                                            <button>Наршараб</button>
                                                            <button className="fatSource" data-info="  Столовая ложка — 13,5 г">
                                                                Оливковое масло
                                                            </button>
                                                            <button data-info="  Столовая ложка — 17 г">Подсолнечное масло
                                                            </button>
                                                            <button>Сало</button>
                                                            <button data-info="  Столовая ложка — 16 г">Соевый соус</button>
                                            ...
                                            <fieldset className="regularButtonsCont">
                                                ...
                                                <div className="plate">
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            <button className="proteinSource" data-info="  1 порция - 50 г">4UZE +
                                                                Сreatine
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 29,4 г">ON 100% Whey Gold
                                                                Standard
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 31 г">ON 100% Casein
                                                                Protein
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 50 г">ON Platinum Hydrowhey
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 27 г">Dymatize Elite Whey
                                                                Protein
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 34 г">Dymatize Elite XT
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 33 г">Dymatize Elite Casein
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 47,2 г">BSN Syntha-6
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 38 г">BSN Syntha-6 Isolate
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 32,8 г">Animal Whey
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  1 порция - 3 ст.л. - 30 г">OstroVit WPC80.eu
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  1 порция - 3 ст.л. - 30 г">OstroVit Micellar
                                                                Casein
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 33,6 г">MusclePharm Combat
                                                                Powder
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 27,3 г">MusclePharm Combat
                                                                100% Isolate
                                                            </button>
                                                            <button className="proteinSource" data-info="  Одна порция - 30 г">
                                                                FitMax Isolate 90
                                                            </button>
                                                            <button className="proteinSource" data-info="  Одна порция - 33 г">
                                                            ...
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 29.9 гр">SAN Pure Platinum
                                                                Whey
                                                            </button>
                                                            <button className="proteinSource" data-info="  Одна порция - 30.1 гр">
                                                                SAN Platinum Isolate Supreme
                                                            </button>
                                                            <button className="proteinSource"
                                                                    data-info="  Одна мерная ложка - 37 гр">SAN 100% Casein
                                                                Fusion
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="plate">
                                                    <div className="groopOfProducts foodPanel">
                                                        ...
                                                        <div>
                                                            <button data-info="  Одна мерная ложка - 165 г">ON Pro Complex
                                                                Gainer
                                                            </button>
                                                            <button data-info="  Порция на один прием - 3 мерных ложки - 150 г">
                                                                Dymatize Elite Mass gainer
                                                            </button>
                                                            <button data-info="  Порция на один прием - 3 мерных ложки - 165 г">
                                                                BSN True-Mass Gainer
                                                            </button>
                                                            <button data-info="  Порция на один прием - 3 мерных ложки - 165 г">
                                                                Animal Mass
                                                            </button>
                                                            <button data-info="  Порция на один прием - 100 г">OstroVit MASS
                                                                IT
                                                            </button>
                                                            <button data-info="  Порция на один прием - 60 г">Fitmax Pure
                                                                American Gainer
                                                            </button>
                                                            <button data-info="  Порция на один прием - 60 г">FitMax Bulk Mass
                                                            </button>
                                                            <button data-info="  Порция на один прием - 50 г">FitMax Mass
                                                                Active
                                                            </button>
                                                            <button data-info="  Порция на один прием - 70 г">FitMax Easy Gain
                                                                Mass
                                                            </button>
                                                        </div>
                                                    </div>
                                ...
                                <div className="tableFAQ">
                                    <h2 className="h2 crowdFindInfo">Сохрани свой рацион питания и добавь продуты в таблицу!</h2>
                                    <div className="intro">
                                        <p>Привет!</p>
                                        ...
                                        <p>Не многие из вас поняли, о чем вообще шла речь в предыдущем абзаце, так зачем я это
                                            рассказываю? </p>
                                ...
                                <!--                        <h2 class="heading hideManualHeading">Инструкция по самостоятельному составлению плана-->
                                <!--                            питания:</h2>-->
                                <!--                        <div class="videoManual embed-responsive embed-responsive-16by9">-->
                                <!--                            <iframe allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen"-->
                                <!--                                    msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen"-->
                                <!--                                    webkitallowfullscreen="webkitallowfullscreen" class="embed-responsive-item"-->
                                <!--                                    src="./food_files/lBbAogGBEPE.htm"></iframe>-->
                                <!--                        </div>-->
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="article">
                                            <div class="boxmain artcal1">
                                                <div class="cover top">
                                                    <h2 class="arttitle"><a href="http://3-x-15.ru/2017/05/15/calories-counter/"
                                                                            target="_blank">1. Счетчик калорий.</a></h2>
                                                    <a class="readmoar" href="http://3-x-15.ru/2017/05/15/calories-counter/"
                                        ...
                                        <div class="article">
                                            <div class="boxmain artcal2">
                                                <div class="cover top">
                                                    <h2 class="arttitle"><a href="http://3-x-15.ru/2017/05/20/calories-2/"
                                                                            target="_blank">2. Сырые продукты и прочие
                                                        “мелочи”.</a></h2>
                                                    <a class="readmoar" href="http://3-x-15.ru/2017/05/20/calories-2/"
                                                       target="_blank">Почему
                                                        считать калории нужно на вес продуктов до приготовления, а еще о том,
                                                        что “полезных” или “вредных” калорий не бывает, и все они должны быть
                                                        учтены.</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="article">
                                            <div class="boxmain artcal3">
                                                <div class="cover top">
                                                    <h2 class="arttitle"><a href="http://3-x-15.ru/2017/05/17/calories-3/"
                                                    ...
                                                    <a class="readmoar" href="http://3-x-15.ru/2017/05/17/calories-3/"
                                                       target="_blank">Объединяем
                                                        ...
                                                        невозможное: посчитать калории в готовом блюде на примере борща.</a>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="article">
                                            <div class="boxmain artmet1">
                                                <div class="cover top">
                                                    <h2 class="arttitle"><a href="http://3-x-15.ru/2016/10/19/metabolism-1/"
                                        ...
                                        <div class="article">
                                            <div class="boxmain artmet2">
                                                <div class="cover top">
                                                    <h2 class="arttitle"><a href="http://3-x-15.ru/2016/10/20/metabolism-2/"
                                                                            target="_blank">2. Сухая масса тела</a></h2>
                                                    <a class="readmoar" href="http://3-x-15.ru/2016/10/20/metabolism-2/"
                                                       target="_blank">С
                                                        помощью данных научных исследований и цветных картинок рассматривается
                                                ...
                                                <div class="cover top">
                                                    ...
                                                    <a class="readmoar"
                                                       ...
                                                       target="_blank">Простым
                                                        языком объясняю, как использовать интервальные тренировки и силовой
                                                        тренинг, чтобы вызвать эффект “догорания” и ускорить метаболизм.</a>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
