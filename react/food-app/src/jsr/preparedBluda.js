import {addFoodsByRequestUtil, addNewTableUtil, makeItActiveUtil} from "./newUtil";

export function applyGotovueBluda($) {
    var makeItActive = function (eatingName) {
        makeItActiveUtil($, eatingName)
    }
...
// примеры готовых наборов - гейнер, который можно добавить в рацион
    $(".gainer1").click(function () {
        ...
        addFoodsByRequestUtil($,"Творог 2%, Творог 2%, Йогурт фруктовый, Йогурт фруктовый, Банан, Курага, Курага, Курага, Курага, Курага, Варенье малиновое");
        g1++;
    });
    $(".gainer2").click(function () {
        ...
        addFoodsByRequestUtil($,"Творог 2%, Творог 2%, Груша, Изюм, Изюм, Изюм, Арахис, Арахис, Мёд, Мёд, Какао Nesquik, Какао Nesquik");
        g2++;
    });
    $(".gainer3").click(function () {
        ...
        addFoodsByRequestUtil($,"Творог 2%, Творог 2%, Курага, Курага, Курага, Курага, Курага, Сахар, Сахар, Сметана 10%, Сметана 10%, Банан, Молоко 2,5%, Молоко 2,5%");
        g3++;
    });
    $(".borcsh").click(function () {
        ...
        addFoodsByRequestUtil($,"Говядина, Говядина, Говядина, Говядина, Говядина, Говядина, Говядина, Говядина, Говядина, Говядина, Картофель, Картофель, Картофель, Капуста белокочанная, Капуста белокочанная, Капуста белокочанная, Свекла, Свекла, Свекла, Морковь, Морковь, Лук репчатый, Лук репчатый, Чеснок, Чеснок, Чеснок, Подсолнечное масло, Томатная паста, Томатная паста, Томатная паста");
        g4++;
    });
    $(".schi").click(function () {
        var smthToAdd = "";
        ...
        addFoodsByRequestUtil($,"Говядина, Говядина, Говядина, Говядина, Говядина, Капуста белокочанная, Капуста белокочанная, Капуста белокочанная, Капуста белокочанная, Капуста белокочанная, Картофель, Картофель, Морковь, Лук репчатый, Лук репчатый, Томатная паста, Чеснок, Чеснок, Чеснок, Подсолнечное масло, Подсолнечное масло");
        g5++;
    });
    $(".harcho").click(function () {
        ...
        addFoodsByRequestUtil($,"Баранина, Баранина, Баранина, Баранина, " +
